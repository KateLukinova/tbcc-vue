<template>
  <nav class="main-menu">
    ...
    <ul class="sidebar-menu">
      <li>
        <router-link to="/home" class="sidebar-menu__item">
      ...
      <li>
        <router-link to="/wallet" class="sidebar-menu__item">
      ...
      <li>
        <router-link to="/buy-token" class="sidebar-menu__item">
    ...
    <ul class="sidebar-menu logout">
      <li>
        <router-link to="/kyc" class="sidebar-menu__item">
          <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
